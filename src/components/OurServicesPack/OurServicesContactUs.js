...
import confused_man_and_woman from "../../images/confused_man_and_woman.jpg";

function OurServicesContactUs() {
  ...
  return (
    <div className="w-full flex flex-col items-center py-20 px-4">
      ...
      <div className="flex scr1000:flex-row flex-col items-center justify-center">
        <img
          src={confused_man_and_woman}
          alt=""
          className="scr1000:w-[600px] w-full scr1000:order-1 order-2 max-h-[500px] object-contain"
        />
        <Link to="/contact" className="scr1000:order-2 order-1">
          <div
            className=" w-fit h-fit mt-6 text-white font-cera font-black text-base uppercase px-10 py-4  rounded-[50px] bg-blue-900 cursor-pointer relative overflow-hidden flex items-center justify-center"
...
export default OurServicesContactUs;
