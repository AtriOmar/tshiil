...
import contactUsImg from "../../images/contact_us.jpg";
      ...
      {code ? (
        ...
        >
          <div className="scr800:w-5/12 w-full py-14 px-6">
            <h1 className="font-teko text-5xl font-bold text-white text-center">Vous avez une question?</h1>
            ...
            <img src={contactUsImg} alt="" className="w-full rounded-lg mt-8" />
          </div>
