      ...
      {success ? (
        <div className="flex flex-col items-center">
          <h1 className="font-medium text-lg text-slate-900 font-cera text-center">
            Votre message a été envoyé avec succès, nous vous répondrons dès que possible dans les 24 heures
          </h1>
        ...
        <form className="flex flex-col items-center " onSubmit={verifyCode}>
          <h1 className="font-medium text-slate-900 text-lg font-cera text-center">
